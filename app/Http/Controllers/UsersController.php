...
class UsersController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(Request $request, Users $model)
    {
        //Validate data

        $data = $request->all();

        $new_record = Users::create($data);
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(Users $model)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Users $model)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, Users $model)
    {
        $key = 'id';
    ...
    public function destroy($id)
    {
        if (!is_null($id) && is_numeric($id)){
            $deleted_rows = Users::find($id)->delete();
